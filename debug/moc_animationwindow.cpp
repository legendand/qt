...
QT_MOC_LITERAL(1, 16, 13), // "animationOver"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "AnimationWindow\0animationOver\0"
};
...
void AnimationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnimationWindow::animationOver)) {
                *result = 0;
                return;
            }
        }
